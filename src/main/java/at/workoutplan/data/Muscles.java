...
public class Muscles {
    ...
    public static final List<Muscle> Muscles = Arrays.asList(Chest, Latissimus, Trapezius, FrontDelts, SideDelts, RearDelts, Biceps, Brachialis, Triceps, Forearms, Quadriceps, Hamstrings, Gluteus, Gastrocnemius, Soleus, Abdominal);
}
